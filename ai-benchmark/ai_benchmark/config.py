...
class TestConstructor:
    ...
    def getTests(self, app):
        if "MobileNet-V2" in app:
            benchmark_tests = [ Test(test_id=1, test_type="classification", model="MobileNet-V2", model_src="mobilenet_v2.meta",
                 use_src=False,
        ...
        elif "Inception-V3" in app:
            benchmark_tests = [ Test(test_id=2, test_type="classification", model="Inception-V3", model_src="inception_v3.meta",
                 use_src=False,
        ...
        elif "Inception-V4" in app:
            benchmark_tests = [ Test(test_id=3, test_type="classification", model="Inception-V4", model_src="inception_v4.meta",
                 use_src=False,
        ...
        elif "Inception-ResNet-V2" in app:
            benchmark_tests = [ Test(test_id=4, test_type="classification", model="Inception-ResNet-V2", use_src=False,
        ...
        elif "ResNet-V2-50" in app:
            benchmark_tests = [ Test(test_id=5, test_type="classification", model="ResNet-V2-50", use_src=False,
        ...
        elif "ResNet-V2-152" in app:
            benchmark_tests = [ Test(test_id=6, test_type="classification", model="ResNet-V2-152", use_src=False,
            ...
            benchmark_tests = [ Test(test_id=7, test_type="classification", model="VGG-16", use_src=False,
        ...
        elif "SRCNN-9-5-5" in app:
            benchmark_tests = [ Test(test_id=8, test_type="enhancement", model="SRCNN 9-5-5", model_src="srcnn.meta", use_src=False,
        ...
        elif "VGG-19-Super-Res" in app:
            benchmark_tests = [ Test(test_id=9, test_type="enhancement", model="VGG-19 Super-Res", model_src="vgg19.meta", use_src=False,
        ...
        elif "ResNet-SRGAN" in app:
            benchmark_tests = [ Test(test_id=10, test_type="enhancement", model="ResNet-SRGAN", model_src="srgan.meta", use_src=False,
        ...
        elif "ResNet-DPED" in app:
            benchmark_tests = [ Test(test_id=11, test_type="enhancement", model="ResNet-DPED", model_src="dped.meta", use_src=False,
            ...
            benchmark_tests = [ Test(test_id=12, test_type="segmentation", model="U-Net", model_src="unet.meta", use_src=False,
        ...
        elif "Nvidia-SPADE" in app:
            benchmark_tests = [ Test(test_id=13, test_type="segmentation", model="Nvidia-SPADE", model_src="spade.meta", use_src=False,
            ...
            benchmark_tests = [ Test(test_id=14, test_type="segmentation", model="ICNet", model_src="icnet.meta", use_src=False,
            ...
            benchmark_tests = [ Test(test_id=15, test_type="segmentation", model="PSPNet", model_src="pspnet.meta", use_src=False,
            ...
            benchmark_tests = [ Test(test_id=16, test_type="segmentation", model="DeepLab", model_src="deeplab.meta", use_src=False,
        ...
        elif "Pixel-RNN" in app:
            benchmark_tests = [ Test(test_id=17, test_type="enhancement", model="Pixel-RNN", model_src="pixel_rnn.meta", use_src=True,
        ...
        elif "LSTM-Sentiment" in app:
            benchmark_tests = [ Test(test_id=18, test_type="nlp", model="LSTM-Sentiment", model_src="lstm.meta", use_src=True,
        ...
        elif "GNMT-Translation" in app:
            benchmark_tests = [ Test(test_id=19, test_type="nlp-text", model="GNMT-Translation", model_src="gnmt.meta", use_src=False,
                 tests_training=[],
